  ...
  Modules.StepByStepNavigation = function() {
    ...
    this.start = function($element) {
      ...
      function storeScrollPosition() {
        ...
        document.body.scrollTop = $step && $step.length ? $step.offset().top : 0;
      }
        ...
        $stepHeaders.each(function() {
          ...
          if (!$(this).find(".js-toggle-link").length) {
            $(this)
              ...
              .append(
                '<span class="app-step-nav__toggle-link js-toggle-link" aria-hidden="true">' + linkText + "</span>"
              );
          }
        });
      }
      ...
      function getStepForAnchor() {
        ...
        return anchor.length ? $element.find("#" + escapeSelector(anchor.substr(1))) : null;
      }
      ...
      function ensureOnlyOneActiveLink() {
        ...
        if (lastClicked) {
          ...
          var activeLinkInActiveStep = $element
            .find(".app-step-nav__step--active")
    ...
    function StepView($stepElement) {
      ...
      this.title = $stepElement
        .find(".js-step-title-text")
        .text()
        .trim();
