! function (t, e) {
    ...
    function e(t, e) {
            ...
            "Element" in this && "HTMLElement" in this || function () {
                if (!window.Element || window.HTMLElement) {
                    ...
                    o.attachEvent("onpropertychange", function (t) {
                        for (var e, n = t.propertyName, r = !i.hasOwnProperty(n), s = o[n], c = i[n], l = -1; e = a[++l];) 1 === e.nodeType && (r || e[n] === c) && (e[n] = s);
                        i[n] = s
        ...
        function (t) {
            ...
            "defineProperty" in Object && function () {
            ...
            }() || (e = Object.defineProperty, n = Object.prototype.hasOwnProperty("__defineGetter__"), o = "Getters & setters cannot be defined on this javascript engine", i = "A property cannot both have accessors and be writable or have a value", Object.defineProperty = function (t, r, a) {
                if (e && (t === window || t === document || t === Element.prototype || t instanceof Element)) return e(t, r, a);
                ...
                var s = String(r),
                    c = "value" in a || "writable" in a,
                    l = "get" in a && typeof a.get,
                    u = "set" in a && typeof a.set;
                if (l) {
                    ...
                    window.Event = Window.prototype.Event = function (e, n) {
                        ...
                        t._events || (t._events = {}), t._events[n] || (t._events[n] = function (e) {
                            ...
                            for (e.preventDefault = function () {
                                ...
                                }, e.currentTarget = t, e.relatedTarget = e.fromElement || null, e.target = e.target || e.srcElement || t, e.timeStamp = (new Date).getTime(), e.clientX && (e.pageX = e.clientX + document.documentElement.scrollLeft, e.pageY = e.clientY + document.documentElement.scrollTop); ++a < s && !e.cancelImmediate;) a in r && -1 !== o(i, n = r[a]) && "function" == typeof n && n.call(t, e)
        ...
        function (t) {
            "bind" in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
                value: function (t) {
                    ...
                    }), f.prototype && (a.prototype = f.prototype, b.prototype = new a, a.prototype = null), b
                }
            })
        }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof global && global || {});
    ...
    i.prototype.handleInputs = function (t, e) {
            ...
            if (t) {
                var e, n = this.$summary = t.getElementsByTagName("summary").item(0),
                    i = this.$content = t.getElementsByTagName("div").item(0);
                if (n && i) i.id || (i.id = "details-content-" + (e = (new Date).getTime(), void 0 !== window.performance && "function" == typeof window.performance.now && (e += window.performance.now()), "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (t) {
                    var n = (e + 16 * Math.random()) % 16 | 0;
                    return e = Math.floor(e / 16), ("x" === t ? n : 3 & n | 8).toString(16)
                }))), t.setAttribute("role", "group"), n.setAttribute("role", "button"), n.setAttribute("aria-controls", i.id), o || (n.tabIndex = 0), !0 === (null !== t.getAttribute("open")) ? (n.setAttribute("aria-expanded", "true"), i.setAttribute("aria-hidden", "false")) : (n.setAttribute("aria-expanded", "false"), i.setAttribute("aria-hidden", "true"), o || (i.style.display = "none")), this.handleInputs(n, this.setAttributes.bind(this))
            }
            ...
            (e.setAttribute("aria-expanded", i ? "false" : "true"), n.setAttribute("aria-hidden", r ? "false" : "true"), o) || (n.style.display = i ? "none" : "", null !== t.getAttribute("open") ? t.removeAttribute("open") : t.setAttribute("open", "open"));
            return !0
                ...
                return function (e, o) {
                    var i = this,
                        ...
                        d = function () {
                            ...
                            for ("" === (r = "object" == typeof e[o] ? ("" + e[o].baseVal).replace(/^\s+|\s+$/g, "").split(c) : ("" + e[o]).replace(/^\s+|\s+$/g, "").split(c))[0] && (r = []), a = {}, n = 0; n < r.length; ++n) a[r[n]] = !0;
                            s = r.length, u()
                        };
                    return d(), n(i, "length", function () {
                        ...
                        for (var t, n, c = 0, l = t.length; c < l; ++c) n = t[c], a[n] || (r.push(n), a[n] = !0);
                        s !== r.length && (s = r.length >>> 0, "object" == typeof e[o] ? e[o].baseVal = r.join(" ") : e[o] = r.join(" "), u())
                    }, i.remove = function () {
                        d.apply(i, t = arguments);
                        for (var t, n = {}, c = 0, l = []; c < t.length; ++c) n[t[c]] = !0, delete a[t[c]];
                        for (c = 0; c < r.length; ++c) n[r[c]] || l.push(r[c]);
                        r = l, s = l.length >>> 0, "object" == typeof e[o] ? e[o].baseVal = r.join(" ") : e[o] = r.join(" "), u()
                    }, i.toggle = function (e, n) {
                        return d.apply(i, [e]), t !== n ? n ? (i.add(e), !0) : (i.remove(e), !1) : a[e] ? (i.remove(e), !1) : (i.add(e), !0)
                    }, i
                }
        ...
        function (t) {
                        ...
                        if (a[s] = !0, !1 === e) {
                            for (var c, l = o.mirror || document.createElement("div"), u = l.childNodes, d = u.length, p = 0; p < d; ++p)
                                if (u[p]._R === a) {
                                    c = u[p];
                                    break
                                } c || (c = l.appendChild(document.createElement("div"))), t = DOMTokenList.call(c, a, r)
        ...
        }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof global && global || {}), r.prototype.init = function () {
            var t = this.$module;
            ...
            var e = t.checked;
            t.setAttribute("aria-expanded", e), document.querySelector("#" + t.getAttribute("aria-controls")).classList.toggle("govuk-checkboxes__conditional--hidden", !e)
            ...
            var e = t.checked;
            t.setAttribute("aria-expanded", e), document.querySelector("#" + t.getAttribute("aria-controls")).classList.toggle("govuk-radios__conditional--hidden", !e)
        ...
        }, l.prototype.onHashChange = function (t) {
            var e = window.location.hash;
            if (this.hasTab(e))
                if (this.changingHash) this.changingHash = !1;
                else {
                    var n = this.getCurrentTab(),
                        o = this.getTab(e) || this.$tabs[0];
                    this.hideTab(n), this.showTab(o), o.focus()
                }
        }, l.prototype.hasTab = function (t) {
            return this.$module.querySelector(t)
        }, l.prototype.hideTab = function (t) {
            this.unhighlightTab(t), this.hidePanel(t)
        }, l.prototype.showTab = function (t) {
            this.highlightTab(t), this.showPanel(t)
        }, l.prototype.getTab = function (t) {
            return this.$module.querySelector('a[role="tab"][href="' + t + '"]')
        ...
        }, l.prototype.unsetAttributes = function (t) {
        ...
        }, l.prototype.activateNextTab = function () {
        ...
        }, l.prototype.activatePreviousTab = function () {
            var t = this.getCurrentTab(),
                e = t.parentNode.previousElementSibling;
            if (e) var n = e.firstElementChild;
            n && (this.hideTab(t), this.showTab(n), n.focus(), this.createHistoryEntry(n))
        }, l.prototype.getPanel = function (t) {
            return this.$module.querySelector(this.getHref(t))
        }, l.prototype.showPanel = function (t) {
            this.getPanel(t).classList.remove(this.jsHiddenClass)
        }, l.prototype.hidePanel = function (t) {
            this.getPanel(t).classList.add(this.jsHiddenClass)
        }, l.prototype.unhighlightTab = function (t) {
            t.setAttribute("aria-selected", "false"), t.classList.remove("govuk-tabs__tab--selected"), t.setAttribute("tabindex", "-1")
        }, l.prototype.highlightTab = function (t) {
            t.setAttribute("aria-selected", "true"), t.classList.add("govuk-tabs__tab--selected"), t.setAttribute("tabindex", "0")
        }, l.prototype.getCurrentTab = function () {
            return this.$module.querySelector(".govuk-tabs__tab--selected")
        }, l.prototype.getHref = function (t) {
            var e = t.getAttribute("href");
            return e.slice(e.indexOf("#"), e.length)
        }, t.initAll = function () {
            new n(document).init(), e(document.querySelectorAll("details"), function (t) {
                new i(t).init()
            }), e(document.querySelectorAll('[data-module="checkboxes"]'), function (t) {
                new r(t).init()
            }), new a(document.querySelector('[data-module="error-summary"]')).init(), new s(document.querySelector('[data-module="header"]')).init(), e(document.querySelectorAll('[data-module="radios"]'), function (t) {
                new c(t).init()
            }), e(document.querySelectorAll('[data-module="tabs"]'), function (t) {
                new l(t).init()
            })
        }, t.Button = n, t.Details = i, t.Checkboxes = r, t.ErrorSummary = a, t.Header = s, t.Radios = c, t.Tabs = l
});